...
const Footer = () => {
  return (
    <footer className="bg-gray-900 text-gray-300 py-10 md:py-14">
      <div className="max-w-11/12 mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10">
        
        {/* Logo + About - Full width on mobile, left on desktop */}
        <div className="text-center md:text-left">
          <div className="flex justify-center md:justify-start">
            <img
              src="https://i.ibb.co/Kc5ZbjT4/logo-1-removebg-preview.png"
              alt="Logo"
        ...
        <div className="flex justify-center">
          <div className="text-center md:text-left">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <NavLink to="/how-we-work" className="hover:text-orange-400 transition block">
                  How We Work
                </NavLink>
              </li>
              <li>
                <NavLink to="/membership" className="hover:text-orange-400 transition block">
                  Membership Plans
                </NavLink>
              </li>
              <li>
